...
export default function NotFound() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-background text-foreground relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-sky-500/10 rounded-full blur-3xl animate-pulse delay-1000" />
      ...
      >
        ...
        >
          ...
          <h1 className="text-8xl font-display font-bold bg-gradient-to-r from-primary to-sky-400 bg-clip-text text-transparent" data-testid="text-404">
            404
          </h1>
        </motion.div>
