          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center md:text-left">
            <div>
              ...
              <ul className="space-y-2 text-xs text-white/40">
                <li><Link href="/feed" className="hover:text-cyan-400 transition-colors">Feed</Link></li>
                <li><Link href="/discover" className="hover:text-cyan-400 transition-colors">Discover</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs text-white/40">
                ...
                <li><a href="https://dwsc.io" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors">DWSC R&D</a></li>
              </ul>
            </div>
            <div>
